      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="relative bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-xl border border-white/30 rounded-3xl p-8 w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl"
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center space-x-3 mb-3">
                          <Icon className={`${exportOptions.template === template.id ? 'text-white' : 'text-white/70'} w-5 h-5`} />
