        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="absolute z-[9999] w-full mt-2 bg-blue-500/20 backdrop-blur-xl border border-blue-400/30 shadow-2xl rounded-lg max-h-48 overflow-hidden relative"
              style={{
