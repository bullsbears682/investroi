                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                      ...
                      <motion.button
                        ...
                        className="bg-white/10 hover:bg-white/20 text-white px-6 py-2 rounded-lg font-medium text-sm transition-all"
                      >
                        Customize
                      </motion.button>
                  ...
                  {cookieTypes.map((cookie) => (
                    <div key={cookie.key} className="flex items-start space-x-3">
                      <input
                        ...
                        className="mt-1 w-4 h-4 text-blue-400 bg-white/10 border-white/20 rounded focus:ring-blue-400 focus:ring-2 disabled:opacity-50"
                      />
                      <div className="flex-1">
                        <div className="flex items-center space-x-2">
                          <span className="text-white font-medium">{cookie.name}</span>
                          {cookie.necessary && (
                        ...
                        <p className="text-white/60 text-sm mt-1">{cookie.description}</p>
                      </div>
                    </div>
                  ))}
                </div>
