            ...
            <AnimatePresence>
              {isMiniScenarioOpen && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0, y: -10 }}
                  className="absolute bottom-full left-0 right-0 mb-2 bg-white/20 backdrop-blur-xl border border-white/30 rounded-xl overflow-hidden z-[99999999] max-h-[400px] sm:max-h-[300px] overflow-y-auto sm:top-full sm:bottom-auto sm:mt-2 sm:mb-0"
                >
                  <div className="p-2">
