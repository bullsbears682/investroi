...
const ScenarioSelector: React.FC<ScenarioSelectorProps> = ({
  ...
  return (
    <div className="space-y-6 relative z-[99999999]">
          ...
          <AnimatePresence>
            {isScenarioOpen && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, y: -10 }}
                                  className="absolute top-full left-0 right-0 mt-2 bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl overflow-hidden z-[99999999] max-h-[200px] overflow-y-auto"
              >
                {/* Search */}
                <div className="p-3 border-b border-white/20">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-white/20 border border-gray-300 rounded-lg px-10 py-2 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50"
                    />
                  </div>
                </div>
            ...
            <AnimatePresence>
              {isMiniScenarioOpen && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0, y: -10 }}
                  className="absolute top-full left-0 right-0 mt-2 bg-white/90 backdrop-blur-lg border border-white/30 rounded-xl overflow-hidden z-[99999999] max-h-[180px] overflow-y-auto"
                >
                  <div className="p-2">
