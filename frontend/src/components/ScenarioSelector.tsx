          ...
          <AnimatePresence>
            {isScenarioOpen && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, y: -10 }}
                                  className="absolute bottom-full left-0 right-0 mb-2 bg-transparent backdrop-blur-none border-0 rounded-xl overflow-hidden z-[9999999] max-h-[500px] overflow-y-auto"
              >
                {/* Search */}
            ...
            <AnimatePresence>
              {isMiniScenarioOpen && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0, y: -10 }}
                  className="absolute bottom-full left-0 right-0 mb-2 bg-white/10 backdrop-blur-xl border border-white/20 rounded-xl overflow-hidden z-[9999999] max-h-96 overflow-y-auto"
                >
                  <div className="p-2">
